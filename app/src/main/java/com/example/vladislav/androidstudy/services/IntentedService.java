...
public class IntentedService extends IntentService {
    ...
    private static final String ACTION_BAZ = "com.example.vladislav.androidstudy.services.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "com.example.vladislav.androidstudy.services.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.example.vladislav.androidstudy.services.extra.PARAM2";

    public IntentedService() {
        super("IntentedService");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, IntentedService.class);
